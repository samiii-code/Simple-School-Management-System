  ...
  template: `
    <div class="shell">
      ...
      <aside class="sidebar" [class.collapsed]="collapsed()">
        ...
        <!-- Nav -->
        <nav class="nav">
          <div class="nav-section-label" [class.hidden]="collapsed()">MAIN MENU</div>

          <a class="nav-item" routerLink="/admin/users" routerLinkActive="active"
             [matTooltip]="collapsed() ? 'Users' : ''" matTooltipPosition="right">
            <span class="material-symbols-outlined nav-icon">group</span>
            @if (!collapsed()) { <span class="nav-label">Users</span> }
          </a>

          <a class="nav-item" routerLink="/admin/subjects" routerLinkActive="active"
             [matTooltip]="collapsed() ? 'Subjects' : ''" matTooltipPosition="right">
            <span class="material-symbols-outlined nav-icon">menu_book</span>
            @if (!collapsed()) { <span class="nav-label">Subjects</span> }
          </a>

          <a class="nav-item" routerLink="/admin/grades" routerLinkActive="active"
             [matTooltip]="collapsed() ? 'Grades' : ''" matTooltipPosition="right">
            <span class="material-symbols-outlined nav-icon">grade</span>
            @if (!collapsed()) { <span class="nav-label">Grades</span> }
          </a>
        </nav>
      ...
      <div class="main">
        ...
        <header class="topbar">
          ...
          <div class="topbar-right">
            <div class="user-chip">
              <span class="material-symbols-outlined user-icon">admin_panel_settings</span>
