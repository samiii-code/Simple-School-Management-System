  ...
  template: `
    <div class="shell">
      ...
      <aside class="sidebar" [class.collapsed]="collapsed()">
        ...
        <nav class="nav">
          <div class="nav-section-label" [class.hidden]="collapsed()">TEACHER</div>

          <a class="nav-item" routerLink="/teacher/grades" routerLinkActive="active"
             [matTooltip]="collapsed() ? 'My Grades' : ''" matTooltipPosition="right">
            <span class="material-symbols-outlined nav-icon">assignment</span>
            @if (!collapsed()) { <span class="nav-label">My Grades</span> }
          </a>
        </nav>
      ...
      <div class="main">
        <header class="topbar">
          <div class="topbar-left">
            <span class="topbar-title">Teacher Portal</span>
          </div>
